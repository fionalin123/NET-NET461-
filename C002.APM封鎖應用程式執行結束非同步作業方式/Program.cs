...
namespace C002.APM封鎖應用程式執行結束非同步作業方式
{
    ...
    // https://docs.microsoft.com/zh-tw/dotnet/standard/asynchronous-programming-patterns/blocking-application-execution-by-ending-an-async-operation
    //
    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                // 這個網址服務將會回傳 "Delay 5000ms" 並會延遲 5 秒鐘
                string URL = "http://mocky.azurewebsites.net/api/delay/5000";
